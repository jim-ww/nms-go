...
// }
//
// func New(logger *slog.Logger, jwtService *jwt.JWTService, passwordHasher password.PasswordHasher, repo AuthRepository, validatr *validator.Validate) *AuthService {
// 	return &AuthService{
// 		logger:    logger,
// 		jwt:       jwtService,
